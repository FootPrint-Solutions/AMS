...
Route::get('/sales-order/items/{id}', [SalesOrder::class, 'getItems'])->name('sales-order.getItems')->middleware('permission:view_sales_order_(so)');
...
Route::post('/sales-order/export/audit', [SalesOrder::class, 'exportAudit'])->name('sales-order.export.audit')->middleware('permission:view_sales_order_(so)');
