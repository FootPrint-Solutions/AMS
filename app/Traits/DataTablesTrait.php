...
trait DataTablesTrait
{
    ...
    public static function getAllRowsGallery($request, $query, $selectColumns, $searchColumns = null, $orderDefault = null)
    {
        // Get DataTables configuration request.
        $start = $request->input("start");
        $length = $request->input("length");
        ...
        if ($orderColumn !== null) {
            ...
            if ($orderDefault !== null) {
                ...
                $query->orderBy("galleries.updated_at", "desc");
            }
        }
    ...
    public static function getAllRowMenu($request, $query, $selectColumns, $searchColumns = null, $orderDefault = null, $orderColumnCustom)
    {
        // Get DataTables configuration request.
        $start = $request->input("start");
        $length = $request->input("length");
