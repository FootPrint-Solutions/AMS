...
class AccountingExpenseModel extends Model
{
    ...
    public static function generateVoucherNumber()
    {
        ...
        if (empty($latestCode) || strlen((string) $latestCode) < 7) {
            return 'EX' . $currentYear . $currentMonth . '00001';
        }
    ...
    {
        return $this->hasMany(AccountingExpenseDetailModel::class, 'cb_expense_id', 'id');
    }
}
