    ...
    <div class="container">
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    <td style='width:60%;'>Jenis Pesanan : Tokopedia dan instalasi</td>
        ...
        <div class="section" style="margin-top:50px;">
            ...
            <table>
                <tr>
                    <td style='width:60%;'>Nama Partner : {{ $workOrder->salesOrder->distributorShop->name ?? '' }}
                    </td>
                    <td>Order ID : {{ $workOrder->salesOrder->sales_order_number }} </td>
                </tr>
                <tr>
            ...
            <div class="row">
                ...
                <div class="column" style='padding: 00px;'>
