...
<body>
    @foreach ($data['profile'] as $consignmentIndex => $consignment)
        @php
            $sc_number = isset($consignment['sales_consignment_number'])
                ? str_replace('AK', 'KP', $consignment['sales_consignment_number'])
                : 'N/A';
        @endphp

        {{-- First page for each consignment --}}
                ...
                <div class="pagebreaking">
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                ...
                                <td colspan="5" class="judul2">Sales Consignment</td>
                            </tr>
                            <tr>
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                                <td class="judul">{{ $consignment['vendor']['name'] ?? 'PT. Polarg Indonesia' }}</td>
                                <td class="judul">{{ $consignment['ship_to']['name'] ?? '' }}</td>
                            </tr>
                            <tr>
                                <td class="text" style="padding: 0px;">
                                    {{ $consignment['vendor']['address'] ?? 'Green Sedayu Bizpark blok DM9 no 72' }}
                                </td>
                                <td class="text" rowspan="3" style="padding:0px;">
                                    {{ $consignment['ship_to']['address'] ?? '' }}
                                </td>
                            </tr>
                            <tr>
                                <td class="text" style="padding: 0px;">PIC:
                                    {{ $consignment['vendor']['contact_person'] ?? 'Arifin M Gunawan' }}</td>
                            </tr>
                            <tr>
                                <td class="text" style="padding: 0px;">TEL: (+62)
                                    {{ $consignment['vendor']['contact'] ?? '081510388867' }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <tbody>
                        <tr valign="top" width="100%;">
                            <td width="100%;" colspan="7">
                                ...
                                <table border="0" height="100px;" width="100%;" cellpadding="0"
                                    cellspacing="0">
                                    <tbody>
                                        <tr valign="top" width="100%;">
                                            <td width="100%;" colspan="7">
        ...
        {{-- Second page for each consignment --}}
            ...
            <div id="header0">
                <div class="pagebreaking">
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td class="judul" width="50%">Daftar Kode Produksi untuk
                                    {{ $consignment['sales_consignment_number'] ?? '' }}</td>
                                <td class="judul"></td>
                            </tr>
                        </tbody>
                    </table>
                                                ...
                                                @if (!empty($consBat['sales_invoice']['batteries']))
                                                    @foreach ($consBat['sales_invoice']['batteries'] as $battery)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text">{{ $battery['production_code'] ?? '' }}
                                                            </td>
                                                        </tr>
                                                        @php
                                                            $total += $battery['quantity'] ?? 0;
        ...
        {{-- page break between consignments (except for the last one) --}}
        @if ($consignmentIndex < count($data['profile']) - 1)
            <div style="page-break-before: always;"></div>
        @endif
    @endforeach
</body>
