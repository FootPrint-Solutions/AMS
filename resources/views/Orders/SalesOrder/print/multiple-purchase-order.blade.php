                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text" colspan="2" style="padding: 0px;"></td>
                            <td class="text" colspan="3" style="padding: 0px;"></td>
                        </tr>
                        <tr>
                            ...
                            <table border="1" width="100%;" cellpadding="0" cellspacing="0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="header text" width="37%">No. Purchase Order</th>
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="3" class="text center">Tidak ada data baterai
                                                        untuk profil {{ $profileIndex + 1 }}.</td>
                                                </tr>
                                            @endif
                                        @endforeach
                                    @else
                                        <tr>
                                            <td colspan="3" class="text center">Tidak ada data profil.</td>
                                        </tr>
                                    @endif
                                </tbody>
                                <tfoot>
