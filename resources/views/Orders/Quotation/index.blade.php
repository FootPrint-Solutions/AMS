                            ...
                            <div class="tab-pane active" id="progress-seller-details">
                                ...
                                <form>
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="customer-full-name"
                                                value="Azunyan">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="customer-address"
                                                value="Jalan Hokago Tea Time no. 54">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="border rounded p-2">
                                                ...
                                                <span class="btn btn-success"><i class="fa fa-plus-circle"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col text-end">
                                            <a href="javascript: void(0);" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target=".confirmModal">OK</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane active" id="seller-details">
                                ...
                                <form id='FormPersonalDetails'>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control" id="FullName"
                                                    name="FullName" placeholder="Enter Full Name" value="" required
                                                    autocomplete="off">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group local-forms">
                                                <label for="company-name">Email <span
                                                        class="login-danger">*</span></label>
                                                <input type="text" class="form-control" id="EmailCustomer"
                                                    name="EmailCustomer" placeholder="Enter Email" value=""
