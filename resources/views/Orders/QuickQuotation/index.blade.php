...
<div class="d-none d-lg-block">
                        ...
                        <ul class="twitter-bs-wizard-nav">
                            <li class="nav-item active">
                                <a href="#seller-details" class="nav-link" data-toggle="tab">
                                    <div class="step-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Personal Detail">
                            ...
                            <li class="nav-item" id="ProductDisplay">
                                <a href="#product-display" class="nav-link" data-toggle="tab">
                                    <div class="step-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Product Recomendation Display">
                            ...
                            <li class="nav-item" id="CheckoutDisplay">
                                <a href="#company-document" class="nav-link" data-toggle="tab">
                                    <div class="step-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Checkout Page">
    ...
    <div class="modal fade" id="ModalCopyLinkBattery" tabindex="-1" role="dialog" aria-labelledby="ModalCopyLinkBattery" aria-hidden="true">
...
<script async src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCAlBnX9jmy3JurAGnyIAFNSyS7i5cgfzA&libraries=places&loading=async">
</script>
{{-- END DESKTOP VERSION --}}
