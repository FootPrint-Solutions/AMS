        ...
        <div class="card-body">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-4">
                    <div class="row align-items-center">
                        <div class="col-5">
                            <input type="date" class="form-control" id="input-work-order-instruction-date-start" onchange="reloadTable()">
                        </div>
                        <div class="col-2 text-center">
                            to
                        </div>
                        <div class="col-5">
                            <input type="date" class="form-control" id="input-work-order-instruction-date-end" onchange="reloadTable()">
                        </div>
                    </div>
                </div>
