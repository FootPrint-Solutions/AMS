...
@section('content')
        ...
        <div class="card-body">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Battery Brand</h3>
                    </div>
                    <div class="col-auto text-end float-end ms-auto download-grp">
                        <button id="btn-add" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add
                            New Battery Brand</button>
                    </div>
                </div>
            </div>
            <br>
            ...
            {{-- Table --}}
            <table class="table table-striped" id="table-battery-brand">
                <thead>
                    <tr>
                        <th scope="col">#</th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $("#table-battery-brand").DataTable({
                lengthMenu: [
                    [5, 10, 25],
                    [5, 10, 25]
                ],
        ...
        function destroy(id) {
            sendDestroyRequest(id, "/battery/brand/destroy");
