                ...
                <form id="journal-import-form" action="/journal-transaction/import" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <ul class="mb-3 ps-3 small">
                            <li>Fill in <strong>Date</strong>, <strong>Note</strong>, and <strong>Account Number</strong> on every row.</li>
                            <li>Rows with the same Date and Note will be grouped into one journal transaction.</li>
                            <li>Account Number must match exactly as shown in Chart of Accounts (including dots).</li>
                            <li>Voucher Number will be auto-generated by the system.</li>
                            <li>For each row, fill either <strong>Debit</strong> or <strong>Credit</strong> (leave the other as 0).</li>
                        </ul>
