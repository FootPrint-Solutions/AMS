...
<script>
    $("#btnCopyOrderDetail").on("click", function() {
        ...
        $.ajax({
            url: "/experimental/quick-quotation/checkout/copy",
            type: "POST",
            data: data,
    ...
    $(document).on('click', '.add-row', function() {
        ...
        // html += '<td><div class="input-group"><input type="checkbox" name="IsInstallationIncluded[]" id="IsInstallationIncluded" class="form-check-input IsInstallationIncluded" value="0"></div></td>';
        html +=
    ...
    $(document).on('keyup', '.BatteryNameCheckout', function() {
        ...
        if (query != '') {
            $.ajax({
                url: "/experimental/quick-quotation/battery/autoComplete",
                method: "GET",
                data: {
                    query: query,
