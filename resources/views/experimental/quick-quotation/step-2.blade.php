...
<script>
    ...
    $("#ContactNumber").on('keyup', function() {
        ...
        if (input.length > 0) {
            $.ajax({
                url: "/experimental/quick-quotation/customer/findbycontact",
                type: "GET",
                data: {
                    input: input
                },
    ...
    $("#BtnShareBattery").click(function() {
        ...
        Battery.forEach(function(battery) {
            ...
            $.ajax({
                url: "/experimental/quick-quotation/battery/share",
                type: "POST",
                data: data,
                success: function(data) {
    ...
    function showMapsDistributor() {
        ...
        $.ajax({
            url: "/experimental/quick-quotation/customer/maps/near",
            type: "GET",
            data: data,
            success: function(data) {
