...
@section('content')
                        ...
                        <div id="basic-pills-wizard" class="twitter-bs-wizard">
                            ...
                            <div class="tab-content twitter-bs-wizard-tab-content">
                                <div class="tab-pane active" id="seller-details">
                                    @include('experimental.quick-quotation.step-1')
                                </div>
                                <!-- tab pane -->
                                <div class="tab-pane" id="product-display">
                                    @include('experimental.quick-quotation.step-2')
                                </div>
                                <!-- tab pane -->
                                <div class="tab-pane" id="checkout">
                                    @include('experimental.quick-quotation.step-3')
                                </div>
                                <!-- tab pane -->
                                <div class="tab-pane" id="bank-detail">
                                    @include('experimental.quick-quotation.step-4')
                                </div>
                                <!-- tab pane -->
                            </div>
                            <!-- end tab content -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#BtnShareFormPersonalDetails').on('click', function() {
                ...
                swal.fire({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: "/experimental/quick-quotation/customer/share",
                            type: "POST",
                            data: data,
            ...
            $(".product-next-btn").on('click', function() {
                ...
                if ($('#CheckoutDisplay').hasClass('active')) {
                    ...
                    $.ajax({
                        url: "/experimental/quick-quotation/checkout",
                        type: "GET",
                        data: data,
                        success: function(data) {
            ...
            $("#btnNextStep4").on('click', function() {
                ...
                $.ajax({
                    url: "/experimental/quick-quotation/payment",
                    type: "GET",
                    data: data,
                    success: function(data) {
            ...
            $("#BtnShareInvoice").on('click', function() {
                ...
                $.ajax({
                    url: "/experimental/quick-quotation/share-invoice",
                    type: "POST",
                    data: data,
                    success: function(data) {
                        let ResponseData = JSON.parse(data);
            ...
            $("#BtnSharePaymentDetails").on('click', function() {
                ...
                $.ajax({
                    url: "/experimental/quick-quotation/share-payment-details",
                    type: "POST",
                    data: data,
                    success: function(data) {
                        let ResponseData = JSON.parse(data);
            ...
            $("#ButtonSaveData").on('click', function() {
                ...
                $.ajax({
                    url: "/experimental/quick-quotation/save-data",
                    type: "POST",
                    data: data,
                    success: function(data) {
                        let ResponseData = JSON.parse(data);
        ...
        function CopyLinkBattery(x) {
            ...
            $.ajax({
                url: "/experimental/quick-quotation/get-link-battery",
                type: "GET",
                data: data,
                success: function(data) {
                    if (data.error) {
    ...
    <script>
        ...
        function initMapsMobile() {
            initializeMap('map-mobile', 'address_input_mobile_alternative', 'latitude_input_mobile',
                'longitude_input_mobile',
    ...
    {{-- We can disable mobile version inclusion if we want to focus on desktop first or if we don't need experimental mobile view --}}
    {{-- @include('Mobile.experimental.quick-quotation.index') --}}
@endsection
