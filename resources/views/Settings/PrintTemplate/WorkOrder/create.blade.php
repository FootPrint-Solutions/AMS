        ...
        <div class="card-body">
            ...
            <form id="template-master-form">
                    ...
                    <div class="col">
                        <div class="form-group local-forms">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                placeholder="Enter Template Name" required autocomplete="off"
                                @if (isset($data['template'])) value="{{ $data['template']['name'] }}" @endif>
                        </div>
                    </div>
                ...
                <input type="hidden" id="id" name="id"
                    @if (isset($data['template'])) value="{{ $data['template']['id'] }}" @endif>

                {{-- Buttons --}}
                <div class="d-flex flex-row-reverse">
                    {{-- Create or Update Button --}}
                    <button type="submit" class="btn btn-success mx-1" id="btn-save"
                        @isset($data['template']) value="update">
                    Update
                    @else
                    value="create">
                    Create @endisset
