<div>
            ...
            <div class="col-lg-6">
                <div class="mb-3 form-group local-forms">
                    ...
                    <input type="text" class="form-control" id="address_input_mobile_alternative"
                        name="address_input_mobile_alternative">
                </div>
    ...
    <ul class="pager wizard twitter-bs-wizard-pager-link d-none">
        <li class="previous disabled"><a href="javascript: void(0);" class="btn btn-primary seller-previous-btn"><i
                    class="bx bx-chevron-left me-1"></i>
                Previous</a></li>
        <li class="next"><a href="javascript: void(0);" class="btn btn-primary seller-next-btn"
                id="recomendation-display-mobile-next-button">Next <i class="bx bx-chevron-right ms-1"></i></a></li>
    </ul>
    ...
    <div class="bottom-buttons pager wizard twitter-bs-wizard-pager-link">
        ...
        {{-- next button --}}
        <button id="recomendation-display-mobile-next-button-lower" class="btn btn-custom btn-next next"
...
<div class="modal fade" id="modalMapsDistributorMobile" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
...
<script>
    ...
    $('#recomendation-display-mobile-next-button-lower').click(function() {
        ...
        var data = {
            ...
            Latitude: $('#latitude_input_mobile').val() || '0',
            Longitude: $('#longitude_input_mobile').val() || '0',
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success == true) {
                    ...
                    $("#adaddress_customer_checkout_mobile_alternative").text(response.data
                        .AlternativeAddress);
                    ...
                    response.data.Battery.forEach(function(battery) {
                        ...
                        var batteryNetPriceTax = batteryPrices.price_retail +
                            batteryPriceTax;
                        var discountBatteryPercent = batteryPrices.discount;
                        var discountPrice = batteryPrices.discount_price;
                        var batteryNetPrice = (batteryPrices.price_retail +
                                batteryPriceTax) -
                            discountPrice;
